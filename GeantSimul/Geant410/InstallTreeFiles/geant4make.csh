...
setenv G4INCLUDE "`cd $geant4make_root/../../../include/Geant4; pwd`"
setenv G4LIB "`cd $geant4make_root/../../../lib/Geant4-9.5.1; pwd`"

if ( ! ${?DYLD_LIBRARY_PATH} ) then
  setenv DYLD_LIBRARY_PATH "`cd $geant4make_root/../../../lib; pwd`"
else
  setenv DYLD_LIBRARY_PATH "`cd $geant4make_root/../../../lib; pwd`":${DYLD_LIBRARY_PATH}
endif
