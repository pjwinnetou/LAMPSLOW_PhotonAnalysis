...
int make_dE_E_root()
{
  ...
  TH2F *h_dE_E = new TH2F("h_dE_E","E1 vs E_{Total} (E1+E2);E_{Total};E1",900,0,300,280,0,14);
  TH2F *h_dE_E_veto = new TH2F("h_dE_E_veto","E1 vs E_{Total} (E1+E2) with veto;E_{Total};E1",900,0,300,280,0,14);
